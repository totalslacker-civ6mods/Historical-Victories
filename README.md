...
1. Land of the Free : None
- Build the Statue of Liberty wonder
- Create the first air unit in the world
- Activate 10 great people
2. Transcontinental Railroad : < 1890AD
- Build 50 railroads
- Own 5 Canal districts
3. Arsenal of Democracy : <= Modern Era
- First Democracy government
- Levy military 4 times
- Kill 10 units with the American P51

### LEADER_BASIL_II
1. Holy Wisdom : < 700AD
   - Build the Hagia Sophia wonder
2. Defender of Orthodoxy : == 1200AD
   - Kill 10 units with the Byzantine Tagma unit
   - Conquer 5 cities with the Byzantine Tagma unit
   - Convert all cities to your religion
3. Fall of Constantinople : < 1500AD
   - Occupy 3 capital cities
   - Control 3 Holy Cities
   - Own 5 cities on foreign continents

### LEADER_CLEOPATRA_ALT
1. Ptolemaic Dynasty : None
   - Build the Great Lighthouse and the Great Library in the same city
2. Alexandrian Kingdom : None
   - Control a named sea territory of at least size 6
   - Control a named desert territory of at least size 6
3. Nile Delta : == 30BC
   - Own 3 cities with a population of 10
   - Have the highest culture

### LEADER_ELEANOR_ENGLAND
1. Hundred Years War : < 1450AD
   - Occupy 2 capital cities
   - Convert 4 cities through loyalty
2. Angevin Dynasty : End of Medieval Era
   - Have the highest city population
   - Own 8 Great Works
3. The Crusades : <= Medieval Era
   - Control 2 Holy Cities
   - Own 4 cities on foreign continents

### LEADER_ELIZABETH
1. Elizabethan Era : End of Renaissance Era
   - Have all cities follow the same religion
   - Own 6 Great Works of Writing
   - Accumulate 4000 gold
2. Age of Piracy : End of Renaissance Era
   - Pillage 20 plots with the English Sea Dog unit
   - Kill 10 units with the English Sea Dog unit
   - Have the most outgoing trade routes
3. Royal Navy : End of Modern Era
   - Have the most naval units
   - Create 30 historical moments by sinking ships
   - Be the first to construct a trading post in every civilization

### LEADER_GORGO
1. Spartan Valor : None
   - Kill 10 units with the Greek Hoplite unit
   - Promote 2 Greek Hoplite units to level 8
   - Conquer 5 cities with the Greek Hoplite unit
2. Doric Columns : <= Classical Era
   - Build the Statue of Zeus wonder
   - Unlock all civics from the Classical Era
3. Peloponnesian League : <= Classical Era
   - Achieve suzerainty over 2 city-states
   - Occupy 2 capital cities

### LEADER_HARALD_ALT
1. Great Heathen Army : None
   - Conquer 5 cities with the Norwegian Berserker unit
   - Pillage 10 plots with the Norwegian Berserker unit
   - Promote 1 Norwegian Berserker unit to level 8
2. Council of the Althing : <= Medieval Era
   - Achieve suzerainty over 4 city-states
   - Create 4 historical moments by levying military
3. Valhalla : <= Medieval Era
   - Own 5 Stave Church buildings
   - Control 3 Holy Cities

### LEADER_JULIUS_CAESAR
1. Gallic Wars : < 50BC
   - Build 5 Roman Fort improvements
   - Conquer 5 cities with the Roman Legion unit
2. Bread and Circuses : None
   - Build the Colosseum wonder within 6 plots of 6 cities
   - Complete 10 Bread and Circuses projects
   - Be the first to adopt Fascism
3. Richer Than Crassus : <= Medieval Era
   - Accumulate 10000 gold
   - Create 10 historical moments by destroying barbarian camps

### LEADER_KUBLAI_KHAN_CHINA
1. Yuan Dynasty : < 1368AD
   - Occupy 3 capital cities
...
### LEADER_QIN
1. Qin Dynasty : <= Classical Era
   - Build the Terracotta Army wonder
   - Be the first to research Civil Service
   - Recruit 3 Great People from the Classical Era
2. Grand Canal : End of Medieval Era
   - Own 5 Canal districts
   - Accumulate 3000 gold
   - Have the highest number of technologies
3. Great Wall of China : None
   - Build 20 Great Wall improvements
   - Kill 10 units with the Chinese Crouching Tiger unit
   - Enter 3 Golden Ages

### LEADER_RAMSES
1. Monuments of the Pharaohs : < 1700BC
   - Build the Pyramids wonder adjacent to a Sphinx improvement
2. The New Kingdom : < 1050BC
   - Own 6 cities
   - Kill 5 units with the Egyptian Chariot Archer
3. Karnak : End of Classical Era
   - Be the first to recruit a Great Prophet
   - Be the first to construct a Temple building
   - Have the highest culture

### LEADER_SALADIN_ALT
1. Damascus Steel : None
   - Conquer 10 cities with the Arabian Mamluk unit
   - Pillage 20 plots with the Arabian Mamluk unit
   - Kill 30 units with the Arabian Mamluk unit
2. Holy War : None
   - Control 3 Holy Cities
   - Convert the majority of your home continent to your religion
   - Convert all your cities to your religion
3. Desert Empire : <= Medieval Era
   - Build the Petra wonder
   - Control a named desert of at least 12 plots
   - Achieve a 60% monopoly on Incense

### LEADER_SULEIMAN_ALT
1. Kaiser I Rum : < 1566AD
   - Own 10 cities
   - Own 5 cities on a foreign continent
   - Occupy 3 capital cities
2. Barbary Pirates : None
   - Pillage 50 plots with the Ottoman Barbary Corsair unit
   - Control a named sea of at least 8 plots
3. Empire of Wealth : End of Renaissance Era
   - Have the highest culture
   - Own 7 Grand Bazaar buildings
   - Have the highest gold per turn
...
2. Americana : None
   - Build the Broadway wonder
   - Build the Statue of Liberty wonder
   - Build the Panama Canal wonder
3. Foreign Entanglements : None
   - Achieve suzerainty over 4 city-states
   - Reach maximum alliance level with 4 civilizations
   - Achieve a 40% monopoly on Oil

### LEADER_VICTORIA
1. Victorian Era : <= Industrial Era
   - Build the Oxford University wonder
   - Recruit 5 Great People from the Industrial Era
   - Own 20 Great Works
2. Industrial Revolution : < 1860AD
   - Be the first to research Industrialization
   - Build the Big Ben wonder
   - Own 6 Factory buildings
3. The Sun Never Sets : < 1920AD
   - Own at least 1 city on every continent
   - Own 10 cities on foreign continents
   - Kill 20 units with the English Redcoat unit

### LEADER_WU_ZETIAN
1. Tang Dynasty : End of Medieval Era
   - Have the highest city population
   - Have the highest culture
   - Achieve a 60% monopoly on Silk
2. Imperial Exams : None
   - Be the first to research Machinery
   - Be the first to research Gunpowder
   - Be the first to research Printing
3. Palace Intrigue : None
   - Promote 3 spies to level 3
   - Be the first to achieve the "Spy Max Level" historical moment
   - Complete 10 espionage missions

### LEADER_YONGLE
1. Ming Dynasty : <= Renaissance Era
   - Build the Forbidden City wonder
   - Achieve suzerainty over 4 city-states
   - Own 10 cities with a population of 10 or more
2. Treasure Fleets : End of Renaissance Era
   - Control a named sea of at least 8 plots
   - Be the first to research Cartography
   - Have the most outgoing trade routes
3. Myriads : None
   - Complete 10 Lijia Faith projects
   - Complete 10 Lijia Food projects
   - Complete 10 Lijia Gold projects
...
2. Americana : None
   - Build the Broadway wonder
   - Build the Statue of Liberty wonder
   - Build the Golden Gate Bridge wonder
3. Space Race : None
   - Be the first to complete the Manhattan Project
   - Be the first to launch a moon landing
   - Have the highest tourism

### CIVILIZATION_ARABIA
1. Trade Caravans : End of Medieval Era
   - Build the Petra wonder
   - Have the most active trade routes
   - Pillage 15 plots with the Arabian Mamluk unit
2. House of Wisdom : End of Medieval Era
   - Own 4 Madrasa buildings
   - Recruit 4 Great People from the Medieval Era
   - Have the highest culture
3. Caliphate : End of Renaissance Era
   - Have the most cities following your religion
   - Have the highest faith per turn
   - Create 3 historical moments by converting other holy cities
...
3. Surfers Paradise : None
   - Build the Sydney Opera House wonder
   - Build 10 Beach Resort improvements
   - Have the highest tourism

### CIVILIZATION_AZTEC
1. Chinampas : End of Medieval Era
   - Build the Huey Teocalli wonder
   - Have the highest city population
2. Flower Wars : None
   - Kill 20 units with the Aztec Eagle Warrior unit
3. Azatlan : None
   - Own the most cities on your home continent
   - Own 4 Tlachtli buildings
...
### CIVILIZATION_BRAZIL
1. Amazon Civilization : None
   - Control 40 jungle plots
   - Control all plots of the river adjacent to your capital
2. Carnivals : None
   - Be the first to create a full Entertainment Complex
   - Complete 10 Carnival projects
   - Complete 10 Water Carnival projects
3. Brazilian Icons : None
   - Build the Cristo Redentor wonder
   - Build the Estadio do Maracana wonder
   - Own 5 Minas Geraes units
...
### CIVILIZATION_CHINA
1. Dynastic Cycle : None
   - Adopt 10 different governments
   - Build the Forbidden City wonder
   - Be the first to research Civil Service
2. Art of War : None
   - Be the first to recruit a Great General
   - Build the Terracotta Army wonder
   - Kill 10 units with the Chinese Crouching Tiger unit
3. Great Wall of China : None
   - Build 20 Great Wall improvements
...
2. Silk Road Pilgrims : End of Medieval Era
   ...
   - Own 10 Guru units
3. Vedas : None
   - Build the Taj Mahal wonder
   - Build the Mahabodhi Temple wonder
   - Build the Meenakshi Temple wonder

### CIVILIZATION_INDONESIA
1. Spice Islands : None
...
2. Trade Center : End of Medieval Era
   ...
   - Have a trading post in every city
3. Naval Power : None
   - Kill 15 units with the Indonesian Jong unit
   - Sink 30 ships
   - Control a named sea of at least 8 plots

### CIVILIZATION_JAPAN
1. Land of the Rising Sun : None
   - Build the Kotoku-in wonder
   - Control a named sea of at least 6 plots
   - Be the first to have a city with a population of 20
2. Samurai Code : None
...
3. Kongo Basin : None
   - Achieve a 60% monopoly on Ivory
   - Control 20 jungle plots
   - Control all plots of the river adjacent to your capital
...
2. Joseon Dynasty : == 1800AD
   ...
   - Have the highest culture
3. K-Pop : None
   - Promote 1 Rock Band unit to level 4
...
3. Sahel Empire : None
   - Kill 20 units with the Mali Mandekalu Cavalry unit
   - Achieve a 60% monopoly on Salt

### CIVILIZATION_MAORI
1. War Dance : None
   - Kill 20 units with the Maori Toa unit
   - Build 10 Maori Pa improvements
   - Own 5 Marae buildings
2. Mana : None
...
2. Malon Raiders : None
   ...
   - Conquer 5 cities with the Mapuche Malon Raider unit
3. Patagonia : None
   - Control a named mountain range of at least 6 plots
   - Control a named desert of at least 6 plots
   - Discover 1 natural wonder
...
2. Bowmen of Ta-Seti : None
   - Kill 20 units with the Nubian Pitati unit
   - Promote 2 Nubian Pitati units to level 8
3. Monuments of Meroe : None
   - Build the Jebel Barkal wonder adjacent to a Pyramid improvement
   - Build 10 Pyramid improvements
   - Accumulate 6000 gold
...
1. Kaiser I Rum : < 1566AD
   ...
   - Own 5 cities on a foreign continent
   - Occupy 5 capital cities
2. Janissary Corp : None
   - Own 10 Janissary units
   - Conquer 10 cities with the Janissary unit
   - Pillage 10 plots with the Barbary Corsair unit
3. Empire of Wealth : End of Renaissance Era
   - Have the most active trade routes
   - Own 7 Grand Bazaar buildings
...
3. King of Kings : None
   - Be the first to adopt Monarchy
   - Achieve suzerainty over 5 city-states

### CIVILIZATION_PHOENICIA
1. Mercantile Empire : End of Classical Era
   - Have the most outgoing trade routes
   - Accumulate 1500 gold
   - Own the most naval units
2. Refugees of Tyre : <= Classical Era
   - Complete 1 Cothon Capital Move project
   - Own 6 coastal cities
3. Purple Dye Monopoly : None
   - Achieve a 60% monopoly on Dyes

### CIVILIZATION_POLAND
1. Piast Dynasty : == 1368AD
   - Have the highest faith per turn
   - Own 6 Relic Great Works
   - Have all cities follow the same religion
2. Golden Liberty : <= Renaissance Era
   - Own a Sukiennice building in every city
   - Recruit 3 Great People from the Renaissance Era
3. Polish-Lithuanian Commonwealth : < 1648AD
   - Kill 20 units with the Polish Hussar unit
   - Own 6 cities within 6 plots of your capital
...
### CIVILIZATION_RUSSIA
1. For the Motherland : None
   - Build the St. Basil's Cathedral wonder
   - Build the Hermitage wonder
   - Build the Bolshoi Theatre wonder
2. Siberian Frontier : None
...
3. Horse Masters : None
   - Be the first to research Horseback Riding
   - Be the first to research Stirrups
   - Achieve a 60% monopoly on Horses
...
3. Zulu Wars : None
   - Kill 50 units with the Zulu Impi unit
